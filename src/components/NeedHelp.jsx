    ...
    <div className=' md:mx-4 px-6 mt-10 rounded-lg text-center bg-gradient-to-b from-[#C40716] to-[#CC0000] text-white py-8'>
      ...
      >
        ...
        <div className='flex max-sm:flex-wrap justify-center gap-4 mt-2'>
          ...
          <div className='flex items-center gap-3 cursor-pointer bg-[#25D366] text-white px-6 py-4 rounded-md font-normal hover:bg-[#C40716] hover:text-white transition-all duration-300 hover:scale-105 hover:border-white border-2 border-[#25D366] hover:border-2'>
